...
export const SignUpView = () => {
    ...
    <Card className="overflow-hidden p-0">
        <CardContent className="grid p-0 md:grid-cols-2">
            <Form {...form}>
                <form onSubmit= {form.handleSubmit(onSubmit)}className="p-6 md:p-8">
                    <div className=" flex flex-col gap-6">
                      ...
                      text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <Button  disabled={pending}
                        onClick={()=>{onSocial("github")}} variant="outline"
                        type="button"
            ...
            <div className="bg-radial from-sidebar-accent to-sidebar 
            relative hidden md:flex flex-col gap-y-4 items-center 
            justify-center">
